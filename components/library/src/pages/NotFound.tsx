...
const links = [
  { title: 'Documentation', description: 'Learn how to use AID', icon: BookOpenIcon, href:"https://aid.autoai.org/docs/getting-started/intro" },
  { title: 'Source Code', description: 'Read our source code', icon: ViewListIcon, href:"https://github.com/autoai-org/AID" },
  { title: 'Blog', description: 'Read our latest news and articles', icon: RssIcon, href:"https://aid.autoai.org/blog" },
]
const social = [
  {
    name: 'Twitter',
    ...
    <div className="bg-white">
      ...
      <footer className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="border-t border-gray-200 py-12 text-center md:flex md:justify-between">
          <p className="text-base text-gray-400">&copy; AutoAI AID Contributors. All rights reserved.</p>
