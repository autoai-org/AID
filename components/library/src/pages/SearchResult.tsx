    ...
    <MainLayout>
      {loading && progress === 1 && (
        <div style={{ height: "100vh" }}>
          ...
          >
            <svg
              className="animate-spin h-24 w-24 mr-3 ..."
              viewBox="0 0 24 24"
              style={{ marginLeft: "auto", marginRight: "auto" }}
            >
              <circle
            ...
            >
              1/2 Please wait patiently, it may take few minutes...
            </p>
          </div>
        </div>
      )}
      {loading && progress === 2 && (
        <div style={{ height: "100vh" }}>
          ...
          >
            ...
            >
              Analysing and Fetching Metadata...
            </p>
            <p
              className="text-2xl"
              style={{
            ...
            >
              2/2 Please wait patiently, it may take few minutes...
            </p>
          </div>
        </div>
      )}
      {!loading && (
        <DoubleColumn
          left={<Filters search={setIssearch} />}
          main={<ModelList models={packages} />}
        ></DoubleColumn>
      )}
    </MainLayout>
  );
