...
func initDatabase() {
	...
	trainSQLString := "CREATE TABLE IF NOT EXISTS train (id INTEGER PRIMARY KEY, dataId INTEGER, Vendor TEXT, Package TEXT, Solver TEXT, RayId TEXT, Status TEXT, CreatedAt Text)"
	...
	runSQL(trainSQLString, database)
	database.Close()
}
